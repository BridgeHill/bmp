...
bmp8::bmp8():bmpinfo(),colorpad_8()
{
    dataptr = NULL;
}

bmp8::bmp8(unsigned long w,unsigned long h):bmpinfo(w,h),colorpad_8()
{
...
//拷贝构造函数
bmp8::bmp8(const bmp8& pmb):bmpinfo(pmb),colorpad_8()
{
	try
	{
...
bmp8& bmp8::operator=(const bmp8& pmb)
{
    if(this != &pmb)
    {
        type = pmb.type;
...
int bmp8::readfromfile(const char* filename)
{
    fstream file1;
...
int bmp8::write2file(const char* filename)
{
    fstream file1;
...
bmp8& bmp8::operator=(const class bmp32& pmb)
{
